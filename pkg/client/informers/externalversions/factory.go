...
import (
	...
	dnscssapcom "github.com/sap/dns-masquerading-operator/pkg/client/informers/externalversions/dns.cs.sap.com"
...
type SharedInformerFactory interface {
	...
	Dns() dnscssapcom.Interface
}

func (f *sharedInformerFactory) Dns() dnscssapcom.Interface {
	return dnscssapcom.New(f, f.namespace, f.tweakListOptions)
}
